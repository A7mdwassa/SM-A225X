...
ARCH            ?= arm64
CROSS_COMPILE   ?= ${HOME}/toolchains/gcc/bin/aarch64-linux-androidkernel-
...
CC		= ${HOME}/toolchains/clang-r383902b1/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE	?= $(srctree)/toolchain/clang/host/linux-x86/clang-r383902b1/bin/aarch64-linux-gnu-
